...
public class DatabaseConnecting {
    ...
    private static final String DB_TODO_TABLE = "todo"; // nazwa tabeli

    /* stałe opisujace kolumny */
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public DatabaseConnecting(Context context){
            this.context = context;
        }

        public DatabaseConnecting open(){
        ...
        /* Metoda tworzy nowy wpis jedynie na podstawie ciągu znakowego description,
        bowiem id jest generowane automatycznie, natomiast pole completed ma wartość domyślną 0.
         */
